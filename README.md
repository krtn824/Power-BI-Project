...
Collected and imported 7 CSV files into Power BI. Performed data cleaning and transformation using Power Query, including creating calculated columns, adjusting data types, and applying tools such as Date and Number functions to make the data ready for analysis in Power BI.
